    ...
    <Container >
            <Row className="contactArtist my-5">
              <Col xs={12} sm={12} md={12} lg={4} xl={4} style={{textAlign: 'center'}}>
                <Row>
                  <Image className="image" src="../../images/logo.png" style={{height: '25rem', borderRadius: '50%'}}/>
                </Row>
                <Row className="mt-4">
            ...
            <section className='my-5'>
              <Row>
                <Col xs={12} sm={12} md={12} lg={4} xl={4} style={{textAlign: 'center'}}>
                  <Image className="my-5" src="../../images/inconnus.gif" style={{height: '18rem'}}/>
                </Col>

                <Col xs={12} sm={12} md={12} lg={8} xl={8} style={{textAlign: 'center'}}>
